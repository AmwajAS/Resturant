...
public class Main {
	...
	static {
		...
		commands.put("addCustomer", (section, args) -> {
			...
			Customer c = new Customer(args[0], args[1], date, Gender.valueOf(args[5]), Neighberhood.valueOf(args[6]), Boolean.parseBoolean(args[7]), Boolean.parseBoolean(args[8]), null, null);
